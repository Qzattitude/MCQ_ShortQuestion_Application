...
namespace ClassTest_Application
{
    public partial class SetExamPaper : Form
    {
        ...
        private void SetExamPaper_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            foreach (DataRow item in dt.Rows)
            {
                ...
                try
                {
                    string query = "insert into class_test.s_mcq(question, ans) values('" + item[0].ToString() + "','" + item[1].ToString() + "') ";
                    // MessageBox.Show(query);
        ...
        private void Q1Box_TextChanged(object sender, EventArgs e)
        {
